...
gser_type_decoder_f REAL_decode_gser;
gser_type_encoder_f REAL_encode_gser;
...
ssize_t REAL__dump(double d, int canonical, asn_app_consume_bytes_f *cb, void *app_key, int plainOrXER);
