...
#define GSER_DECODER_ERROR_STR_LEN 1024
extern int gser_decoder_trace;
extern char* gser_decoder_str;
extern int gser_decoder_is_error_str_filled;
extern char gser_decoder_error_str[GSER_DECODER_ERROR_STR_LEN+1];


#define GSER_PRINTF(...) do{if (gser_decoder_trace) {printf(__VA_ARGS__);}}while(0);
