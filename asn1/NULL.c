...
NULL__gser_body_decode(const asn_TYPE_descriptor_t *td, void *sptr,
	 ...
	 */
	if((chunk_size == 4) && (memcmp(chunk_buf, "NULL", 4) == 0))
...
asn_dec_rval_t
NULL_decode_gser(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    return gser_decode_primitive(opt_codec_ctx, td,
		...
		NULL__gser_body_decode);
}

asn_enc_rval_t
NULL_encode_gser(const asn_TYPE_descriptor_t *td, const void *sptr, int ilevel,
