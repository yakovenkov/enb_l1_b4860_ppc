...
function(asn1_add_module_library ASN1_LIBRARY_TARGET)
    ...
    foreach(ASN1_ARG ${ARGN})
        ...
        elseif (ASN1_ARG_SELECTOR STREQUAL "debug")
            ...
            set(ASN1_ARG_SELECTOR)
        elseif (ASN1_ARG_SELECTOR STREQUAL "asn1c_prefix")
            set(ASN1C_PREFIX ${ASN1_ARG})
            set(ASN1_ARG_SELECTOR)
        else()
            ...
            elseif(ASN1_ARG_UPPER STREQUAL "ASN1C_PREFIX")
                set(ASN1_ARG_SELECTOR "asn1c_prefix")
    ...
    file(MD5 ${ASN1C_MODULE_LIST_FILE} ASN1_EXPECTED_BUILD_ID)
    ...
    file(MD5 ${ASN1C_EXECUTABLE} ASN1C_EXECUTABLE_HASH)
    ...
    foreach(ASN1_CONFIGURE_DEPENDS ${ASN1_ADD_CONFIGURE_DEPENDS})
        ...
        file(MD5 ${ASN1_CONFIGURE_DEPENDS} ASN1_CONFIGURE_DEPENDS_HASH)
    ...
    foreach(ASN1_MODULE ${ASN1_MODULES})
        ...
        file(MD5 ${ASN1_MODULE} ASN1_MODULE_HASH)
    ...
    if(ASN1_GENERATE_SOURCES)
        ...
        if (NOT ${ASN1C_PREFIX} STREQUAL "")
            set(ENV{ASN1C_PREFIX} ${ASN1C_PREFIX})
        else()
            set(ENV{ASN1C_PREFIX})
        endif()
