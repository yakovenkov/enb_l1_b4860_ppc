...
if (ENABLE_SSE)
    ...
    #
    if (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_CLANG OR CMAKE_COMPILER_IS_ICC)
  ...
  if (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_CLANG OR CMAKE_COMPILER_IS_ICC)
	  ...
	  {
		__m512i a, b, c;
		const int src[16] = { 1, 2, 3, 4, 5, 6, 7, 8 };
		int dst[16];
...
mark_as_advanced(HAVE_SSE, HAVE_AVX, HAVE_AVX2, HAVE_AVX512)
